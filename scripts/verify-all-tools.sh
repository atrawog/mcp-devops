...
docker run --rm $IMAGE bash -c '
    ...
    echo "===================="
    ls -la /usr/bin/just /usr/bin/pixi /usr/bin/tofu /usr/bin/scw /usr/bin/node /usr/bin/npm 2>/dev/null || echo "Checking alternative locations..."
    echo ""
    ...
    su - jovian -c "
        ...
        echo \"  scaleway works:  \$(scw version >/dev/null 2>&1 && echo YES || echo NO)\"
...
echo "• scaleway-cli - for Scaleway cloud management"
